...
def GOAP_script(req):
    ...
    print("cup pos", current.cup_state[0]['no'])
    ...
    if req.emergency == False and counter_scripts == 0: #blue team script
        ...
        scrpit_mission =[13, 12,12,45,14,12,12,12,12,
        # 9,18,21,22
        ] #placecup21,22,19,20, 
        cup_script = [
        # 0,0,0,
        ...
        # scrpit_mission =[87,38,39,13,
        # 12,12,
        # 14,
        # 12,12,##getcup12,12,12,12,12,
        ...
        # ]
        # tuple(position_script)
        # position_script=[[req.my_pos[0],req.my_pos[1],req.my_pos[2]],
        #     [690.0,2820.0, 3.14159], [574.113, 2821.010, 3.126495],[602.252, 2831.025, -2.234627],
        #     current.cup_state[20]['robot_pos'],  current.cup_state[19]['robot_pos'],
        #     [1200.0,2700.0,math.pi], #mission 14
        #     current.cup_state[9]['robot_pos'], current.cup_state[10]['robot_pos'],
        #     [1756.194, 1280.637, 0,], #mission 9 place front 4 cup
        #     [1644.174, 1280.637, 0], #mission 18 place front 2 cup
        #     [1398.960, 1280.637, 0] #mission 23 back off 
        # ]
        # print("position test", position_script[0][0])
        # position_script_test = [690,2820, 3.14159,#wait for little chicken
        # # 401.556,2555.301,-2.294488, #mission 13 hand 21(0,1) cup 21 + 23
        # 574.113, 2821.010, 3.126495,#583.825, 2628.019, -2.914618,#mission 12 hand 1 (1) cup 21
        # 602.252, 2831.025, -2.234627,
        ...
        #     position_script.append([246.743,2485.069,2.307810]) #N x
        #     # cup.append(0)
        #     # cup.append(0)
        #     # cup.append(0)
        ...
        #     position_script.append([1352.316,2619.162,1.612796]) #N x
            # cup.append(0)
            # cup.append(0)
            # cup.append(0)
        ...
        while count_script < len( scrpit_mission):
            ...
            # position.append(position_script[count_script])
            
            # position.append(position_script[count_script][0])
            # position.append(position_script[count_script][1])
            # position.append(position_script[count_script][2])
