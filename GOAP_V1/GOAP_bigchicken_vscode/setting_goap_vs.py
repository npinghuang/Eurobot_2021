...
e1 = (enemy_pos[0], enemy_pos[1])
e2 = (enemy_pos[2], enemy_pos[3])
#name, location, NS, reef_p, reef_l, reef_r, windsock, flag, lhouse, time, e1_location, e2_location
cur = current_state( "cur", ( x, y , theta ), NS, action_list[8], action_list[6], action_list[7], action_list[1], action_list[3], action_list[2], time, emergency, e1, e2)
cur.myfunc("current")
